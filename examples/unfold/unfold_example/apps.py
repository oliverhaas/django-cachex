"""
Unfold example project app configuration.
...
class UnfoldExampleConfig(AppConfig):
    """App configuration that populates sample cache data on startup."""

    name = "unfold_example"
    verbose_name = "Unfold Example Project"
    ...
    def ready(self) -> None:
        ...
        if os.environ.get("RUN_MAIN") == "true" or not os.environ.get("RUN_MAIN"):
            ...
            from unfold_example.startup import ensure_sample_data
